"""
Django settings for calixis project.
...
SECRET_KEY = '#b4#f-63p08q-^jqz(zq*n=nx^aukz_#a3fkk09r8(tr+v(9#b'
...
ROOT_URLCONF = 'calixis.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'calixis', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'calixis.wsgi.application'
