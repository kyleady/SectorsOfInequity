# Generated by Django 2.2.9 on 2020-01-23 04:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='-', max_length=25)),
                ('star_cluster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='plan.Config_Star_Cluster')),
        ...
        migrations.AddField(
            ...
            name='perterbation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='plan.Perterbation'),
        ),
        migrations.AddField(
            model_name='inspiration',
            name='rolls',
