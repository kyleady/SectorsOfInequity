# Generated by Django 2.2.9 on 2020-08-10 06:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('inspiration_tables', models.ManyToManyField(related_name='config_region_inspiration_tables', to='plan.Inspiration_Table')),
                ('tags', models.ManyToManyField(related_name='config_region_tags', to='plan.Tag')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='config_region_type', to='plan.Config_Name')),
                ('weights', models.ManyToManyField(related_name='config_region_weight', to='plan.Roll')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regions', models.ManyToManyField(related_name='config_grid_regions', to='plan.Config_Region')),
